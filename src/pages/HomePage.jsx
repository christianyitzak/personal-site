        ...
        <>
            ...
            <section className="p-5 max-w-2xl mx-auto">
                <h1 className="text-[#dedede] text-3xl font-bold mb-3">
                    hey, chris here ✌️
                    <span className="text-[#83c5fc]">frontend developer</span> ,
                ...
                <button className="flex gap-3 text-[#dedede] font-semibold bg-[#141515] py-2 px-5 rounded-full">
                    See Projects
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        height="24px"
            ...
            <section className="grid grid-cols-1 p-5">
                <div className="bg-[#141515] p-10 rounded-3xl">
                    ...
                    <div className="flex justify-between">
                        <p className="text-[#ffffff4d]">Frontend Developer</p>
                        <p className="text-[#ffffffcc]">/ now</p>
                    </div>
                </div>
            </section>
        </>
